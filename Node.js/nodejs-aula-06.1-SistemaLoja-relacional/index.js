...
connection
  .query(`CREATE DATABASE IF NOT EXISTS lojarelacional;`)
  .then(() => {
...
defineAssociations();
//Sincronizando as tabelas com os relacinamentos
Promise.all([Cliente.sync({ force: false }), Pedido.sync({ force: false })]) //TRUE uma vez e dps false
  .then(() => {
